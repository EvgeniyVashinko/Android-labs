...
//        setDataIn("");
    ...
    public MutableLiveData<String> getCurrentConverterFrom() {
    ...
    public MutableLiveData<String> getCurrentConverterTo() {
...
//    public
    ...
    public MutableLiveData<String> getDataIn() {
        if (dataIn == null) {
    ...
    public MutableLiveData<String> getDataOut() {
        if (dataOut == null) {
